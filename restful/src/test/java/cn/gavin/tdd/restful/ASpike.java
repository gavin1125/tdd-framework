...
import cn.gavin.tdd.container.ComponentRef;
import cn.gavin.tdd.container.Config;
import cn.gavin.tdd.container.Context;
import cn.gavin.tdd.container.ContextConfig;
...
public class ASpike {
    ...
    static class ResourceServlet extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            ...
            writer.writeTo(entity.getEntity(), entity.getRawType(), entity.getType(), result.getAnnotations(),
                    result.getMediaType(),
                    result.getHeaders(), resp.getOutputStream());
        }
    ...
    static class TestResource {
        ...
        public Response withHeaders() {
            return Response.ok().header("Set-Cookie", new NewCookie("SESSION_ID", "SID"))
