...
public class ResourceDispatcherTest {
    ...
    static class Router implements ResourceRouter {
        ...
        public OutboundResponse dispatch(HttpServletRequest request, ResourceContext resourceContext) {
            ...
            ResourceMethod resourceMethod = rootResources.stream().map(root -> root.matches(request.getServletPath(), new String[0], null)).filter(Optional::isPresent).findFirst().get().get();
    ...
    static class NormalResourceMethod implements ResourceMethod {
        ...
        @Override
        public GenericEntity<?> call(ResourceContext resourceContext, UriBuilder builder) {
    ...
    interface ResourceMethod {
        GenericEntity<?> call(ResourceContext resourceContext, UriBuilder builder);
    }
