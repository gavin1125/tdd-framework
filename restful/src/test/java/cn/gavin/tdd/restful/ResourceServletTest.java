...
public class ResourceServletTest extends ServletTest {
    ...
    public List<DynamicTest> RespondWhenExtensionMissing() {
        ...
        Map<String, org.junit.jupiter.api.function.Executable> extensions = Map.of("MessageBodyWriter", () -> response().entity(new GenericEntity<>(1, Integer.class), new Annotation[0]).returnFrom(router),
    ...
    public List<DynamicTest> RespondForException() {
        ...
        Map<String, Consumer<Consumer<RuntimeException>>> exceptions = Map.of("Other Exception", this::otherExceptionsThrowFrom,
    ...
    private void otherExceptionsThrowFrom(Consumer<RuntimeException> caller) {
    ...
    class OutboundResponseBuilder {
        ...
        private OutboundResponse build() {
            ...
            studMessageBodyWriter();

            return response;
        }

        private void studMessageBodyWriter() {
